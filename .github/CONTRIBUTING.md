...
1. **Open issues** — bug reports, recipe proposals, and feature requests
   are all welcome via the issue templates.
2. **Read the architecture** — feedback on
   [`../ARCHITECTURE.md`](../ARCHITECTURE.md) is especially welcome before
   the design ossifies.
3. **Star + watch** — so you'll see the Phase 2 announcement when the PR
   flow opens.
...
Be kind. Assume good faith. The project is small and the maintainer is one
person; patience helps.
